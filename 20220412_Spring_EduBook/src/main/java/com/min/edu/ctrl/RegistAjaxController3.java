...
@Controller
public class RegistAjaxController3 {
	 ...
	 */
	@RequestMapping(value="/duplicateAjax3.do", method=RequestMethod.POST, produces = "application/json; charset=UTF-8;")
	@ResponseBody
	public Map<String, Object> duplicateAjax(String chkId){
		logger.info("RegistAjaxController3 duplicateAjax post 파라미터 값 id:{}",chkId);

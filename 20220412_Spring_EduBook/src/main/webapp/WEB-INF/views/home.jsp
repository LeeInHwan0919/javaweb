...
<body>
  <fieldset>
    <legend>Scope(값을 전달하는 범위)</legend>
    <div>
      ...
      function langChange(){
    	  ...
    	  console.log("선택된 언어는 : "+choiceValue);
          ...
          <table class="table">
            ...
            <tr>
              <td colspan="2">
                ...
                <input class="btn btn-info" type="button" value="회원가입1" onclick="javascript:location.href='./registForm1.do'">
                <input class="btn btn-info" type="button" value="회원가입2" onclick="javascript:location.href='./registForm2.do'">
              </td>
            </tr>
          </table>
        </form>

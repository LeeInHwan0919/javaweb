	...
	<div class="container">
		<form action="./signup.do" method="post">
			...
			<div>
				...
				<input class="form-control" type="text" name="id" id="id" placeholder="아이디 작성(클릭시 중복 체크 화면으로 이동)" maxlength="10" onclick="return duplication()">
				<span id="result"></span>
			...
			<div>
				...
				<input type="button" value="가입취소" onclick="javascript:history.back(-1)">
			</div>
		</form>
	</div>

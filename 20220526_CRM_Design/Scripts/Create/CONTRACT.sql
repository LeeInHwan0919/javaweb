...
CREATE SEQUENCE CONTRACT_SEQ INCREMENT BY 1 START WITH 1;
...
UPDATE CONTRACT
SET DU_PRICE=(SELECT SUM(CONSTRACT_GOODS.G_PRICE*CONSTRACT_GOODS.DU_CNT) 
FROM CONSTRACT_GOODS
WHERE CONTRACT.CT_CODE = CONSTRACT_GOODS.CT_CODE);

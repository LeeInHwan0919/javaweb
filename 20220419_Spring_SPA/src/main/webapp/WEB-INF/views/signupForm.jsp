		...
		<form action="./signup.do" method="post" onsubmit="return check()">
			<div id="info">
				...
				<div id="centerInfo">
					...
					<span id="result"></span>
					<input type="password" id="password" name="pw" placeholder="비밀번호입력" required><br>
					<input type="password" id="passOk" placeholder="비밀번호확인" required><br>
				</div>
				<div id="bottomInfo">
					<div class="usm-agree">
						<input type="checkbox" id="i_agree2" name="i_agree2" value="1"><label
							for="i_agree2">개인정보 수집 및 이용 안내 <strong> (필수)</strong></label>
					</div>
				...
				<div id="bottom">
					<input class="btn btn-success" type="submit" value="동의하고 회원가입하기">
					<input class="btn btn-primary" type="button" value="이전으로 돌아가기" onclick="javascript:history.back(-1)">
				</div>
			</div>
		</form>
	</div>

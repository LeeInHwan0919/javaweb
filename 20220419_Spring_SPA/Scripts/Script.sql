...
INSERT INTO SPRINGBOARD  (SEQ, ID, TITLE, 
      ...
      VALUES(SPRINGBOARD_SEQ.NEXTVAL , 'GD001', '첫번쨰 새글',
          '첫번째 새글 내용', (SELECT NVL(MAX(REFER),0) +1 FROM SPRINGBOARD s),0,
          0,0,'N',SYSDATE);

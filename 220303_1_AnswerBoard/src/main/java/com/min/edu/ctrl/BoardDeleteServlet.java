...
public class BoardDeleteServlet extends HttpServlet {
	...
	private static final long serialVersionUID = 4860581905639249062L;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		logger.info("BoardDeleteServlet doGet 전송받은 paprameterValues : " + Arrays.toString(seq));
	...
	//http://localhost:8088/220303_1_AnswerBoard/boardDelete.do?seq=5&seq=6
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		logger.info("BoardDeleteServlet doPost 전송받은 paprameterValues : " + Arrays.toString(seq));
		boolean isc = dao.deleteBoard(seq);

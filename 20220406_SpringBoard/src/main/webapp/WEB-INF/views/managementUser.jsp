...
<body>
  <div class="container">
    <h1>회원 관리</h1>
    <form action="./managementUser.do" name="form" onsubmit="return checkBox()">
    <table class="table">
      <thead>
      <tr>
        ...
        <%for(UserVo vo:lists){%>
          <tr>
            ...
            <%}else{ %>
              <td>관리자</td>
            <%} %>
            <%if(vo.getAuth().equalsIgnoreCase("N")){ %>
              <td>활성화 계정</td>
            <%}else{ %>
              <td>비활성화 계정</td>
            <%} %>
      ...
      <tfoot>
        <tr>
          <td colspan="7" style="text-align:center;">
            ...
            <button class="btn btn-danger" name="btnChk" value="toUser">일반 유저로 변경</button>
